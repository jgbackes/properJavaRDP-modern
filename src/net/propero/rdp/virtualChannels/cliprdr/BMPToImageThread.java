...
public class BMPToImageThread extends Thread {
    ...
    public BMPToImageThread(RdpPacket data, int length, ClipInterface clipInterface) {
        super();
        this.data = data;
        this.length = length;
        this.clipInterface = clipInterface;
    }
    ...
    public void run() {
        ...
        clipInterface.copyToClipboard(imageSelection);
    }
}
