...
public class TextHandler extends TypeHandler {
    ...
    /* (non-Javadoc)
      * @see net.propero.rdp.virtualChannels.cliprdr.TypeHandler#handleData(net.propero.rdp.RdpPacket, int, net.propero.rdp.virtualChannels.cliprdr.ClipInterface)
      */
    ...
    public void sendData(Transferable in, ClipInterface c) {
        ...
        if (in != null) {
            ...
            //return s.getBytes();
            c.sendClipboardData(s.getBytes(), s.length());
        }
    }
}
